...
export const IconBell = (p) => (
  <svg {...base} {...p}><path d="M18 16v-5a6 6 0 0 0-12 0v5l-2 2h16Z" /><path d="M10 20a2 2 0 0 0 4 0" /></svg>
);
export const IconHelp = (p) => (
  <svg {...base} {...p}><circle cx="12" cy="12" r="9" /><path d="M9.5 9a2.5 2.5 0 0 1 5 0c0 2-2.5 2-2.5 4" /><path d="M12 17h.01" /></svg>
);
...
export const IconFlag = (p) => (
  <svg {...base} {...p}><path d="M4 22V4" /><path d="M4 15c4-3 8 3 12 0V4c-4 3-8-3-12 0" /></svg>
);
...
export const IconAttach = (p) => (
  <svg {...base} {...p}><path d="m21 12-9.5 9.5a5 5 0 0 1-7-7L14 5a3.5 3.5 0 0 1 5 5l-9.5 9.5a2 2 0 0 1-3-3L15 8" /></svg>
);
export const IconTarget = (p) => (
  <svg {...base} {...p}><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="5" /><circle cx="12" cy="12" r="1" /></svg>
);
export const IconChart = (p) => (
  <svg {...base} {...p}><path d="M3 20h18" /><path d="M6 20V11" /><path d="M11 20V6" /><path d="M16 20v-6" /><path d="M21 20V9" /></svg>
);
...
export const IconUsers = (p) => (
  <svg {...base} {...p}><circle cx="9" cy="8" r="4" /><path d="M2 21a7 7 0 0 1 14 0" /><path d="M16 3.5a4 4 0 0 1 0 7.8" /><path d="M22 21a6 6 0 0 0-5-5.9" /></svg>
);
export const IconCompass = (p) => (
  <svg {...base} {...p}><circle cx="12" cy="12" r="9" /><path d="m16.2 7.8-2.8 6.4-6.4 2.8 2.8-6.4 6.4-2.8Z" /></svg>
);
export const IconSun = (p) => (
  <svg {...base} {...p}><circle cx="12" cy="12" r="4" /><path d="M12 2v2" /><path d="M12 20v2" /><path d="m4.93 4.93 1.41 1.41" /><path d="m17.66 17.66 1.41 1.41" /><path d="M2 12h2" /><path d="M20 12h2" /><path d="m4.93 19.07 1.41-1.41" /><path d="m17.66 6.34 1.41-1.41" /></svg>
);
...
export const IconChat = (p) => (
  <svg {...base} {...p}><path d="M21 11.5a8.4 8.4 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.4 8.4 0 0 1-3.8-.9L3 21l1.9-5.7a8.4 8.4 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.4 8.4 0 0 1 3.8-.9h.5a8.5 8.5 0 0 1 8 8v.5Z" /></svg>
);
...
export const IconMegaphone = (p) => (
  <svg {...base} {...p}><path d="M3 11v2a1 1 0 0 0 1 1h2l5 5V5L6 10H4a1 1 0 0 0-1 1Z" /><path d="M15 8a4 4 0 0 1 0 8" /><path d="M19 5a8 8 0 0 1 0 14" /></svg>
);
export const IconNewspaper = (p) => (
  <svg {...base} {...p}><path d="M4 4h13a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4Z" /><path d="M19 8h2v11a2 2 0 0 1-2 2" /><path d="M8 8h7" /><path d="M8 12h7" /><path d="M8 16h7" /></svg>
);
